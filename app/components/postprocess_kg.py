...
def create_node_types_df(graph_df):
    ...
    # This function is no longer needed as we're not using node types
...
def postprocess_knowledge_graph(kg_path, output_path, progress=None):
    """
    ...
    Returns:
        str: Path to the processed output directory
    """
    ...
    if model is None or tokenizer is None:
        ...
        create_node_metadata(df_node_types, metadata_path)
        return output_path
    ...
    # Create and save final graph and metadata
